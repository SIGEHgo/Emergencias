...
CAPA_CONFIG <- list(
  ...
  'g7_c3' = list(tipo_geom="POINT", group="Puntos de Reunión y Centros de Acopio", nombre_buig="comedores_comunitarios_1025", cols=c(""), data = NULL,color = "#621132", size = 2),  # Comedores Comunitarios
